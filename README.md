...
2. Fork [CryptoNote repository](https://github.com/compucepts/coin)
...
Example: 
```
const char CRYPTONOTE_NAME[] = "compuceptscoin";
```
...
Example: 
```
set_property(TARGET daemon PROPERTY OUTPUT_NAME "compuceptscoin")
```
